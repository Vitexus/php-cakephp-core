...
require_once '/usr/share/php/League/Container/autoload.php';
require_once '/usr/share/php/Cake/Utility/autoload.php';

spl_autoload_register(function (string $class): void {
    $prefix = 'Cake\\Core\\';
    if (str_starts_with($class, $prefix)) {
        $file = '/usr/share/php/Cake/Core/' . str_replace('\\', '/', substr($class, strlen($prefix))) . '.php';
        if (file_exists($file)) {
            require $file;
        }
    }
...
require_once '/usr/share/php/Cake/Core/functions.php';
